            ...
            <div class="_SO_d_b">
              <div class="flex-box _Share_detail">
                <div class="_Share_detail_img round_c_s">
                  <img
                    :src="this.$siteURL + '/images/showoff/thumb/' + thumbnail"
                    alt=""
                  />
                </div>
                <div>
                  <h5 class="_Share_title">{{ title }}</h5>
                  <div class="share_des">{{ truncateString(brief, 120) }}</div>
                </div>
              </div>
              <div>
...
export default {
  ...
  methods: {
    ...
    shareOnTwitter() {
      let text = this.title + " by @" + this.owner;
      let URL =
    ...
    copyLink() {
      this.$clipboard(this.$siteURL + "/showoff/" + this.slug);
