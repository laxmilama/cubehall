            ...
            <div class="_SCH_fC">
              ...
              >
                ...
                <svg
                  ...
                  stroke-linejoin="round"
                  class="animExpFtr"
                  v-bind:class="{ exP_fltr: orderBox }"
                >
                  <polyline points="6 9 12 15 18 9"></polyline>
                </svg>
              </div>
              <div
                ...
                v-closable="{
                  exclude: ['forder'],
                  handler: 'closeOrderFilter',
                }"
              >
                <div class="_SCH_ddown round_c_m">order</div>
              </div>
            </div>
    ...
    <div>
      <div class="showoff-show-wrapper">
        <div v-for="(product, index) in items" :key="index">
          ...
          <strong>${{ product.meta.price }}</strong>
        </div>
      </div>
  ...
  mounted() {
    ...
    for (var i = 0; i < sticky.length; i++) {
      new hcSticky(sticky[i], {
        stickTo: sticky[i].parentNode.parentNode.parentNode.parentNode,
        top: 60,
      });
    }
  ...
  methods: {
    ...
    goToSearch() {
      ...
      var view = "/search",
        query = "/s";
      var request = "";
      var request = "?search_product=" + this.product_;
      if (this.color_) {
