<div data-init="footer">
    ...
    ?>
    <mobile-bottom-tab canshowoff="{{ $canshowOff }}"></mobile-bottom-tab>
    <cookie-handler></cookie-handler>
    <bag-notification></bag-notification>
</div>
<div class="footer mbl-hide">
    <footer class="container">
        <div class="footer-wrapper footer-padding">
            <div class="footer-card">
                <div class="footer-card-box">
                    <div class="footer-card-logo">
                        <a href="{{ route('home') }}"><svg xmlns="http://www.w3.org/2000/svg" width="140" height="36"
                                viewBox="0 0 124 30" fill="none" style="enable-background:new 0 0 124.3 32.7;"
                    ...
                    <div class="footer-card-info">
                        {{ env('APP_NAME') }} is the community for creatives to persue entrepreneurship.
                    </div>
                </div>
            ...
            <div class="footer-card">
                ...
                <ul>
                    ...
                    <li><a href="{{ route('program.parlor') }}">Host a parlor</a></li>
                    <li><a href="{{ route('OpenStudio') }}">List products</a></li>
                    <li><a href="{{ route('program.showoff') }}">Showoff your collections</a></li>
                </ul>
            </div>
            <div class="footer-card">
                <h5>CUSTOMER SERVICE</h5>
                <ul>
                    <li><a target="_blank" href="#">Return & Exchange</a></li>
                    <li><a target="_blank" href="https://cubehall.notion.site/Terms-of-Service-25433547302c4e22aa3dd1e6503629a1">Terms of Service</a></li>
                    <li><a target="_blank" href="https://cubehall.notion.site/Privacy-Policy-54903c77ed7c41a58ed9187fcb907843">Privacy Policy</a></li>
                    <li><a target="_blank" href="#">Data Protection</a></li>
                    <li><a href="https://cubehall.notion.site/FAQs-a767a57eb3b34185b6d51655cfa54e9c"
            ...
            <div class="footer-card">
                ...
                <ul>
                    <li><a href="{{ route('about') }}">About {{ env('APP_NAME') }}</a></li>
                    <li><a href="{{ route('brand') }}">Brand Guidline</a></li>
                </ul>
            </div>
        </div>
    </footer>
