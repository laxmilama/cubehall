<div class="navbar-wrapper">
    <header class="navbar-sticky">
        <div data-init="nav">
            <nav class="navbar-container pad-left-right">
                <div class="navbar-container-left">
                    <div class="navbar-logo mb-hide">
                        ...
                        <a href="/">
                            <svg xmlns="http://www.w3.org/2000/svg" width="140" height="36" viewBox="0 0 124 30"
                                ...
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="nav_logo_">
                                <g>
                                    <g>
                                        <path
                    ...
                    <div class="navbar-big-menus">
                        <ul>
                            <li class="fix-item">
                                <mega-menu></mega-menu>
                            </li>
                            <li class=" mb-hide"><a href="/explore">Explore</a></li>
                            <li class=" mb-hide"><a href="/following">Following</a></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <ul class="ico-nav">
                            @auth
                                @if (!Auth::user()->can('isPage'))
                                    <li class="flex-box mb-hide"><a href="{{ route('OpenStudio') }}"
                                            class="btn-secondary btn-normalize">Open a Studio</a></li>
                                @else
                                    <li class="flex-box mb-hide"><a href="{{ route('dashboard') }}"
                                            class="btn-secondary btn-normalize">Switch to Studio</a></li>
                                @endif
                            @endauth
                            @guest
                                <li class="flex-box"><a href="{{ url('/login') }}"
                                        class="btn-secondary btn-normalize">Log In</a><a href="{{ url('/register') }}"
                                        class="btn-primary btn-normalize margin-left-small">Sign Up</a></li>

                            @endguest
                            @if (auth()->check())
                                <li class="navbar-items-round margin-left-small">
                                    <span class="do-notify m_icos">
                                        <user-notification :userid="{{ auth()->user()->id }}"
                            ...
                            @auth
                                <li class="navbar-items-round margin-left-small ">
                                    <user-dropdown ref="userdrop"
                                        avatar="{{ asset('./images/profile/thumb/' . Auth::user()->profile_image) }}"
                                        profile="{{ Auth::user()->slug }}" studio="{{ Auth::user()->can('isPage') }}">
                                    </user-dropdown>
                                </li>
